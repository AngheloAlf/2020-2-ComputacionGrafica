...
void display(void){
    ...
    mode = 0;
    tetrahedron(n);
    printf("\nNumero de triangulos para la primera figura: %d", tri);
    tri = 0;
    mode = 1;
    glTranslatef(-2.0, 0.0, 0.0);
    tetrahedron(n);
    printf("\nNumero de triangulos para la segunda figura: %d", tri);
    tri = 0;
    mode = 2;
    glTranslatef(+4.0, 0.0, 0.0);
    tetrahedron(n);
    printf("\nNumero de triangulos para la tercera figura: %d\n", tri);
    glFlush();
}
